...
public:
    ...
    Q_INVOKABLE int savingImage(const QString &filename, const QString &newfilename);
...
class ImageProcessor20 : public QObject
{
    Q_OBJECT
public:
    explicit ImageProcessor20(QObject *parent = nullptr);
    Q_INVOKABLE int applyFrame(const QString &filename, int choice, int color);
...
class ImageProcessor21 : public QObject
{
    Q_OBJECT
public:
    explicit ImageProcessor21(QObject *parent = nullptr);
    Q_INVOKABLE int checkCropWidth(const QString &filename);
...
class ImageProcessor22 : public QObject
{
    Q_OBJECT
public:
    explicit ImageProcessor22(QObject *parent = nullptr);
    Q_INVOKABLE int checkCropHeight(const QString &filename);
...
class ImageProcessor23 : public QObject
{
    Q_OBJECT
public:
    explicit ImageProcessor23(QObject *parent = nullptr);
    Q_INVOKABLE int applyCrop(const QString &filename, int crop_width, int crop_height, int crop_start_x, int crop_start_y);
