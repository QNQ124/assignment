...
struct qt_meta_stringdata_CLASSFileDownloaderENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFileDownloaderENDCLASS = QtMocHelpers::stringData(
    "FileDownloader",
    "downloaded",
    "",
    "fileDownloaded",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFileDownloaderENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FileDownloader::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSFileDownloaderENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFileDownloaderENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFileDownloaderENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *FileDownloader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFileDownloaderENDCLASS.stringdata0))
